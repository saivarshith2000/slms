...
async def create_department(request: DepartmentSchema, async_session: AsyncSession) -> Department:
    async with async_session() as session:
...
async def update_department(abbr: str, request: DepartmentSchema, async_session: AsyncSession) -> Department:
