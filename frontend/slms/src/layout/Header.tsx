...
export default function Header() {
    ...
    return <div className="flex flex-row justify-between align-middle px-24 py-2 bg-white border-b-gray-200 border-b border-solid">
        <p className="text-xl my-auto"><Link to="/">SLMS</Link></p>
        {user
